...
public class AppendEntriesRequest extends RaftHeader {
    ...
    public int prev_log_term;
    public int entry_term;     // term of the given entry, e.g. when relaying a log to a late joiner
    public int leader_commit;  // the commit_index of the leader
